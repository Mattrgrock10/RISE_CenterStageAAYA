package org.firstinspires.ftc.team8109_Rise.Robots.BeefCake.OpModes.Auton_Opmodes;
...
public class AutonAttempt extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        slides = new BeefySlides(gamepad1, telemetry, hardwareMap);
        arm = new Bicep(gamepad1,telemetry, hardwareMap);
        wrist = new Wrist(gamepad1, hardwareMap);
        claw = new SausageFingers(gamepad1, telemetry, hardwareMap);
...
//
            ...
            case GO_TO_SCORE_PRELOAD:
                slides.slidesState = BeefySlides.SlidesState.HIGH_JUNCTION;
